 ...
 * @author ASSUERO
 */
public class FrmFalhaConexaoArduino extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmFalhaConexaoArduino.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmFalhaConexaoArduino().setVisible(true);
            }
        });
    }
